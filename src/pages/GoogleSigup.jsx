...
const GoogleSignup = () => {
  const { user, login, register, authenticate, logout, isLoading: authLoading } = useAuth();
          ...
          <div className="space-y-8">
            <div className="text-center space-y-2">
              ...
              <p className="text-sm text-slate-500">
                {mode === 'signup' ? 'Create an account with Google or your email' : 'Sign in to continue to your tasks'}
              </p>
            </div>
            ...
            <form className="space-y-4" onSubmit={handleLocalAuth}>
              ...
              <button
                ...
                className="w-full rounded-xl bg-indigo-600 py-3.5 font-semibold text-white transition hover:bg-indigo-700 disabled:opacity-50"
              >
